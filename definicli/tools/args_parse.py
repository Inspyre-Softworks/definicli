...
class CMDLine(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument('term',
                          help="The word which you'd like the definition of.")

        _subparsers = self.add_subparsers(dest='cmds',
        ...
        gui_parser.add_argument(
            ...
            '--console',
            help=
            'Open a second GUI window that contains the console output. (Only really useful if added to a call from a desktop icon, etc.)',
            action='store_true',
            required=False,
            default=False)
        ...
        log_level_grp.add_argument(
            ...
            '--verbose',
            help=
            'Instruct the logger to output all messages to the console. (Exactly the same as passing "--log-level DEBUG"',
            action='store_true',
            required=False,
            default=False)
        ...
        log_level_grp.add_argument(
            ...
            '--log_level',
            help=
            "Specify the level at which you'd like the logger to output messages.",
            action='store',
            choices=LOG_LEVELS,
            default='info',
        )
        ...
        self.add_argument(
            ...
            required=False,
            help=
            "A string representing the path you'd like your application data directory to preside in.",
            default=APP_DIR)
